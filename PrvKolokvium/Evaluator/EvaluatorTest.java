package PrvKolokvium.Evaluator;
...
class EvaluatorBuilder<T extends Comparable<T>>{
    public static <T> IEvaluator build (String operator){
...
class Evaluator{
    ...
    public static <T extends Comparable> boolean evaluateExpression(T left, T right, String operator) {
